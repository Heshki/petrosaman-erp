...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2019 at 10:51 AM
...
CREATE TABLE `group_info` (
  ...
  `g_fur_sup` varchar(50) DEFAULT NULL COMMENT 'سرپرست کوره',
  `g_gra_sup` varchar(50) DEFAULT NULL COMMENT 'سرپرست دانه بندی'
...
INSERT INTO `group_info` (`g_id`, `g_name`, `g_fur_sup`, `g_gra_sup`) VALUES
(4, 'A', 'محسن خلجی', 'احمرضا رشیدی'),
(5, 'B', 'ابراهیم جعفری', 'امیر محمد تیموری');
...
(9, 2, '1398_4', 0, 126667, 66667, 0, 140, 0, 56000, 0, 0, 66000, 315334, 13533, 0, 2000, 35000, 0, 0, 0, -66220, -15687, 331021, '1398/4/16'),
(10, 1, '1398_4', 1000000, 63334, 33334, 3033762, 140, 13369714, 350000, 225000, 1289222, 60000, 19424365, 76767, 0, 59000, 366500, 0, 0, 0, -15000, 487267, 18937098, '1398/4/16');
...
(3, '4', 'A', 'day.night.night.night.night.day.day.day.day.night.night.night.night.rest.rest.rest.rest.rest.rest.rest.rest.night.night.night.night.night.night.day.day.day.day');
...
INSERT INTO `user` (`u_id`, `u_name`, `u_family`, `u_level`, `u_username`, `u_password`, `u_father`, `u_meli`, `u_birth`, `u_live_city`, `u_destination`, `u_mobile`, `u_tell`, `u_address`, `u_pre`, `u_group`, `u_description`, `u_pcode`, `u_wtype`, `u_marital`, `u_evidence`, `u_child_count`, `u_daily_wage`, `u_fix_right`) VALUES
(1, 'امیرعلی', 'شبانی', 'مدیر کل', 'admin', 'admin', '', '', '', '', '', '', '', '', '', 'B', '', '15546', 'سرپرست کوره', 'متاهل', 'ارشد', 5, 500000, 1000000),
...
--
ALTER TABLE `group_info`
  MODIFY `g_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد جدول', AUTO_INCREMENT=6;
...
--
ALTER TABLE `raw_rights`
  MODIFY `rr_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد جدول', AUTO_INCREMENT=6;
