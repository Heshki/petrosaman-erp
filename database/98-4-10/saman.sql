...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2019 at 08:41 PM
...
CREATE TABLE `user` (
  ...
  `u_pcode` varchar(20) CHARACTER SET utf8 DEFAULT NULL COMMENT 'کد پرسنلی',
  `u_wtype` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT 'منصب'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `user` (`u_id`, `u_name`, `u_family`, `u_level`, `u_username`, `u_password`, `u_father`, `u_meli`, `u_birth`, `u_live_city`, `u_destination`, `u_mobile`, `u_tell`, `u_address`, `u_pre`, `u_group`, `u_description`, `u_pcode`, `u_wtype`) VALUES
(1, 'امیرعلی', 'شبانی', 'مدیر کل', 'admin', 'admin', '', '', '', '', '', '', '', '', '', 'A', '', '15546', 'سرپرست کوره'),
(2, 'سید مرتضی', 'مهدوی', 'مدیر', 'mori', 'mori', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ''),
(3, 'مژگان', 'حمزه', 'مدیر', 'hamze', '3050188200m', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ''),
(13, 'سید مرتضی', 'مهدوی', 'مالی', 'mori2', '22', 'محمد رضا', '3040430386', '1398/3/1', '', '200 کیلومت', '09134933739', '03434233072', 'www', 'sad', 'C', 'asdas', NULL, ''),
(15, 'محمد', 'اسماعیلی', 'مالی', 'mrm', '65', '', '', '', '', '', '', '', '', '', 'A', '', '2123123', 'سرپرست کوره'),
(16, 'تست ۱', 'تست ۱', 'مدیر', 'test1', 'test1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '');
