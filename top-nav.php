				  			...
				  			<li>
								...
								<ul class="menu">
					  				...
					  				<li>
										<a href="#">
						  					<div class="pull-right">
												<img src="<?php get_url(); ?>dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
						  					</div>
						  					<h4>
					  				...
					  				<li>
										<a href="#">
						  					<div class="pull-right">
												<img src="<?php get_url(); ?>dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
						  					</div>
						  					<h4>
												Developers
